...
<div id="confirmareliminar" class="row">
  ...
  <a href="{{ route('descargarPDFcategorias') }}" class="btn btn-sm btn-primary">Imprimir PDF</a>
  <a href="{{ route('decargarPDFCategoriasHorizontal') }}" class="btn btn-sm btn-primary">Imprimir Horizontal PDF</a>
  <a href="{{ route('guardarpdf') }}" class="btn btn-sm btn-primary">Guardar PDF</a>
